Shader "TestShaders/ToonWater"
{
    Properties
    {
        ...
        _DepthMaxDistance ("Depth Maxium Distance", Float) = 1
        ...
        // scroll speed, in UVs per second.
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {            
                ...
                float existingDepthLinear = LinearEyeDepth(existingDepth01);  ///LinearEyeDepth
                ...
                float4 waterColor = lerp(_DepthGradientShallow, 
                    _DepthGradientDeep, waterDepthDiff01);

                
                //float foamDepthDiff01 = saturate(depthDiff / _FoamDistance);
                float foamDepthDiff01 = saturate(depthDiff / foamDistance);
                float surfaceNoiseCutoff = foamDepthDiff01 * _SurfaceNoiseCutoff;

                // Add animate the waves.
                float2 distortSample = (
                    tex2D(_SurfaceDistortion, i.distortUV).xy * 2 - 1) * 
                ...
                //float surfaceNoise = surfaceNoiseSample > surfaceNoiseCutoff ?
                //    1 : 0;
